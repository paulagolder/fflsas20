...
class ImageController extends AbstractController
{
    ...
    public function AdminSearch($search, Request $request)
    {
        ...
        {
            $sfield = "%".$pfield."%";
            $images = $this->getDoctrine()->getRepository("App:Image")->findSearch($sfield);
    ...
    {
        $this->getDoctrine()->getRepository('App:Image')->delete($iid);
        $this->getDoctrine()->getRepository('App:Imageref')->deleteAllImages($iid);
        $this->getDoctrine()->getRepository('App:Text')->deleteTexts('image',$iid);
    ...
    public function move()
    {
        $errorlist =array();
        $this->lang = $this->requestStack->getCurrentRequest()->getLocale();
        $images = $this->getDoctrine()->getRepository("App:Image")->findNew();

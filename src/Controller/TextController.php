...
use App\Form\Type\TextForm;
use App\Form\Type\TextForm_server;
...
class TextController extends AbstractController
{
    ...
    public function __construct( LibraryController $mylib ,RequestStack $request_stack)
    {
        $this->mylib = $mylib;
    ...
    {
        $text = $this->getDoctrine()->getRepository('App:Text')->findOne($tid);
    ...
    public function edit_quill($tid)
    {
        ...
        $objecttype = $text->getObjecttype();
        $objid = $text->getObjid();
        $sourcelabel = $this->mylib->getLabel($objecttype,$objid, $this->lang);

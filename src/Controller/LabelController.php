...
class LabelController extends AbstractController
{
    ...
    {
            $label = $this->getDoctrine()->getRepository('App:Label')->findOne($lid);
          $this->getDoctrine()->getRepository("App:Label")->deletebytag($label->gettag(),$label->getMode());
    ...
    public function show($tag)
    {
        ...
        $labels= $this->getDoctrine()->getRepository("App:Label")->findByTags($tag);
        if(!labels)
        {
            $mess = "tags not found";
        } else
    ...
    public function LabelSearch($search, Request $request)
    {
        ...
        {
            $labels = $this->getDoctrine()->getRepository("App:Label")->findmode($mode);

...
class SearchController extends AbstractController
{
    ...
    public function ShowAll(Request $request)
    {
       ...
       $gfield = $request->query->get('searchfield');
        ...
        $locations = $this->getDoctrine()->getRepository("App:Location")->findSearch($pfield);
        foreach($locations as $key => $location)
        {
         ...
         $urls = $this->getDoctrine()->getRepository("App:Url")->findSearch($pfield);
             ...
             case "image":
              ...
              break;
               case "content":
                 ...
                 {
                      $pid = $key;
                       $content =   $this->getDoctrine()->getRepository("App:Location")->findOne($pid);
                       if($content->getAccess()<2)
                       {
              ...
              break;
               ...
               case "biblo":
                 ...
                 {
                      $pid = $key;
                      $biblo =   $this->getDoctrine()->getRepository("App:Biblo")->findOne($pid);
                      if($biblo != null)
                      {

...
class IncidentRepository extends EntityRepository
{
    ...
    {
        $sql = "select i.incidentid,i.personid,i.eventid,i.itypeid,i.name_recorded, i.sdate, i.edate, i.locid,i.comment,it.label from App:Incident i ";
        $sql .= " join App\Entity\IncidentType it with it.itypeid = i.itypeid ";
    ...
    {
        $sql = "select i from App:incident i ";
